...
public class ReferralResult implements Serializable {
   ...
   @ManyToOne
   private ReferralResultCategory category;
   ...
   public ReferralResultCategory getCategory() {
      return category;
   }

   public void setCategory(ReferralResultCategory category) {
   ...
   public String toString() {
      return "medoffice.entity.ReferralResult[id=" + id + "]";
   }
}